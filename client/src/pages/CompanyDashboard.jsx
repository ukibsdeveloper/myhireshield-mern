      ...
      <div className="container mx-auto px-6 pt-32 pb-24 max-w-7xl relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <div className="bg-white border border-slate-100 rounded-[4rem] p-12 shadow-[0_20px_48px_-12px_rgba(73,98,121,0.08)] flex flex-col items-center justify-center text-center relative overflow-hidden group hover:shadow-[0_32px_64px_-16px_rgba(73,98,121,0.15)] transition-all duration-700">
            ...
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-slate-50 rounded-full blur-3xl opacity-50 group-hover:bg-[#4c8051]/10 transition-colors duration-700"></div>
            
            <div className="relative w-48 h-48 mb-10 flex items-center justify-center p-6">
              <svg className="w-full h-full transform -rotate-90 drop-shadow-sm">
                <circle cx="96" cy="96" r="88" stroke="currentColor" strokeWidth="6" fill="transparent" className="text-slate-50" />
                <circle
                  cx="96" cy="96" r="88" stroke="currentColor" strokeWidth="14" fill="transparent"
                  strokeDasharray="552.92"
                  strokeDashoffset={552.92 - (552.92 * trustRating) / 100}
                  strokeLinecap="round"
                  className="text-[#4c8051] transition-all duration-[2000ms] ease-out-expo"
                />
              </svg>
              <div className="absolute inset-0 flex flex-col items-center justify-center group-hover:scale-110 transition-transform duration-700">
                <span className="text-6xl font-black text-[#3a4e61] tracking-[-0.05em] leading-none mb-1">{trustRating}%</span>
                <span className="text-[8px] font-black text-slate-300 tracking-[0.3em] uppercase">INTEGRITY</span>
              </div>
            </div>
            
            <div className="relative z-10 flex flex-col items-center">
              <h3 className="text-[10px] font-black text-slate-400 tracking-[0.5em] mb-4 uppercase">IDENTITY CLEARANCE</h3>
              <div className={`px-6 py-2 rounded-full border transition-all duration-500 ${trustRating > 80 ? 'bg-[#4c8051]/10 border-[#4c8051]/20 text-[#4c8051]' : 'bg-slate-50 border-slate-200 text-slate-500'}`}>
                <p className="text-[9px] font-black tracking-[0.2em] uppercase flex items-center gap-2">
                  <span className={`h-1.5 w-1.5 rounded-full ${trustRating > 80 ? 'bg-[#4c8051] shadow-[0_0_8px_#4c8051]' : 'bg-slate-400'}`}></span>
